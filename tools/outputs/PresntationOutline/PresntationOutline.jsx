    ...
    return (
        ...
        <div style={{ width: 800, height: 792.70, padding: 28, background: '#0C0B17', borderRadius: 20, border: '2px #9D74FF solid', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 36, display: 'inline-flex' }}>
            ...
            <div style={{ alignSelf: 'stretch', height: 633.70, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 24, display: 'flex' }}>
                <div style={{ alignSelf: 'stretch', height: 128, borderRadius: 12, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8, display: 'flex' }}>
                    <div style={{ alignSelf: 'stretch', color: 'white', fontSize: 16, fontFamily: 'Satoshi', fontWeight: '700', wordWrap: 'break-word' }}>Presentation Details</div>
                    <div style={{ alignSelf: 'stretch', height: 98, paddingLeft: 24, paddingRight: 24, paddingTop: 12, paddingBottom: 12, background: '#24272F', borderRadius: 15, flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: 20, display: 'flex' }}>
                        <div style={{ alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 20, display: 'inline-flex' }}>
                            <div style={{ color: 'white', fontSize: 16, fontFamily: 'Satoshi', fontStyle: 'italic', fontWeight: '500', wordWrap: 'break-word' }}></div>
                        </div>
                        <div style={{ paddingLeft: 16, paddingRight: 16, paddingTop: 8, paddingBottom: 8, borderRadius: 20, overflow: 'hidden', border: '1px #DECDFF dotted', justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'inline-flex' }}>
                            <div style={{ color: 'white', fontSize: 12, fontFamily: 'Satoshi', fontWeight: '700', wordWrap: 'break-word' }}>Document.pdf</div>
                            <div data-svg-wrapper style={{ position: 'relative' }}>
                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 3L9 9M9 3L3 9" stroke="#B096FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                        </div>
                    </div>
